...
def generate_launch_description():
    ...
    # File Paths
    nav_params_path = os.path.join(bringup_dir, 'params', 'nav2_params.yaml')
    slam_params_path = os.path.join(bringup_dir, 'params', 'slam_online_async_params.yaml')
    rviz_config_path = os.path.join(bringup_dir, 'rviz', 'nav2_view.rviz')
    ...
    declare_slam_file_cmd = DeclareLaunchArgument(
        'slam_params',
    ...
    bringup_cmd_group = GroupAction([
        PushRosNamespace(
            condition=IfCondition(use_namespace),
            namespace=namespace),
        # Container creation for composition if needed
        Node(
        ...
        # slam_localization or amcl localization
        IncludeLaunchDescription(
    ...
    ld.add_action(declare_slam_file_cmd)
